...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public DBHelper(Context context){
        super(context, "news_portal", null, 1);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table saved_news(id INTEGER primary key NOT NULL,user_id INTEGER NOT NULL, title TEXT NOT NULL, source TEXT, image TEXT,author TEXT,detail TEXT,content TEXT,time TEXT)");
    }
    ...
    public Boolean insertNews(Integer user_id,String title, String source, String image,String author,String detail, String content,String time){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
