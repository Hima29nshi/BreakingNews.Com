        ...
        holder.save_news.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(sessionManagement.isLoggedIn())
                {
                    ...
                    if (checkNews == false) {
                        Boolean insert = DB.insertNews(user_id, headlines.getTitle(), headlines.getSource().getName(), headlines.getUrlToImage(), headlines.getAuthor(), headlines.getDescription(), headlines.getContent(), headlines.getPublishedAt());
                        if (insert != null) {
